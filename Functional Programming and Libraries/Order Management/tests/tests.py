...
class TestCode(unittest.TestCase):
    def test_Python(self):
        ...
        tilaukset=[]
        tilaukset.append(vars(Tilaus('a1123', 'a23432', 8373)))
        tilaukset.append(vars(Tilaus('b1133', 'b2382', 3992)))
        tilaukset.append(vars(Tilaus('c1243', 'c22282', 39124)))

        talleta_tilaukset(tilaukset)
        del tilaukset
        t_list=hae_tilaukset()

        expected_results=['a1123', 'a23432', '8373', 'b1133', 'b2382', '3992', 'c1243', 'c22282', '39124']
        for er in expected_results:
            found=False
            for t in t_list:
                found = found or (er in str(t))
