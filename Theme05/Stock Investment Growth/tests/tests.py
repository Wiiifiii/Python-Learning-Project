...
class TestCode(unittest.TestCase):
    def test_Python(self):
        ...
        my_code=loadmycode()
        print('class Osake implemented?')
        self.assertTrue(my_code.count('class Osake')>=1)
        print('tulosta_arvo implemented?')
        self.assertTrue(my_code.count('def tulosta_arvo')>=1)
        print('laske_tuotto_yhdelle_vuodelle implemented?')
        self.assertTrue(my_code.count('def laske_tuotto_yhdelle_vuodelle')>=1)
